...
VO = [('q1', 1.45), ('q2', 5.55), ('q3', 13.55), ('q4', 17.10),
      ('q5', 20.50), ('q6', 25.50), ('q8', 34.20)]

w = wave.open('music-parents2.wav')
...
for lid, start in VO:
    ...
    g = np.interp(np.log10(np.maximum(fr, 10)),
                  np.log10([10, 90, 190, 500, 1200, 3200, 6500, 11000, SR / 2]),
                  [-30, -18, -7, -2.0, 0, 3.5, 2.5, 0, -6])
...
with wave.open('parents-audio.wav', 'wb') as o:
